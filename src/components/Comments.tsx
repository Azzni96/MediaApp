      ...
      {user && (
        ...
        >
          ...
          <button
            ...
            className="my-2.5 block w-4/5 rounded-md bg-blue-600 p-2 text-center text-white font-semibold transition-all duration-500 ease-in-out hover:bg-blue-800"
            type="submit"
          >
            Post
          </button>
      ...
      {comments.length > 0 && (
        <ul className="mt-4 space-y-2">
          {comments.map((comment) => (
            <li key={comment.comment_id} className="bg-gray-100 p-4 rounded-md shadow-md">
