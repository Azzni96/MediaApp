    ...
    <>
      ...
      >
        <div className="flex w-[80%] flex-col mb-4">
          ...
          />
          {!usernameAvailable && (
            <p className="text-right text-red-500 mt-1">Username not available</p>
          )}
        </div>
        <div className="flex w-[80%] flex-col mb-4">
        ...
        <div className="flex w-[80%] flex-col mb-4">
          ...
          />
          {!emailAvailable && (
            <p className="text-right text-red-500 mt-1">Email not available</p>
          )}
        </div>
        <button
          className="m-[15px] w-4/5 cursor-pointer rounded-md bg-indigo-600 p-[10px] text-white font-semibold transition-all duration-500 ease-in-out hover:bg-indigo-800"
          type="submit"
        >
          Register
        </button>
